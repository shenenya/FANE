        ...
        for source in tqdm(self.graph.nodes(), desc='Computing transition probabilities'):
            ...
            for current_node in self.graph.neighbors(source):
                ...
                for destination in self.graph.neighbors(current_node):
                    ...
                    r = self.sampling_strategy[current_node].get(self.R_KEY,
                                                                 self.r) if current_node in self.sampling_strategy else self.r

                    if current_node.startswith('attri-'):
                        ...
                        elif destination.startswith('attri-'):
